...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      kpis: { totalUsers: 0, activeUsers: 0, newUsersToday: 0, newUsersLast7d: 0, totalTenants: 0, activeTenants: 0, totalConversations: 0, conversationsToday: 0, totalMessages: 0, messagesToday: 0 },
      planDistribution: [],
      recentActivity: [],
      messageTrend: [],
      signupTrend: [],
